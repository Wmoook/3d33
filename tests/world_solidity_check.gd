...
func _ready() -> void:
	...
	for n in [world.decor, world.lights, world.backdrop, world.trials, world.grass, world.foliage, world.keels, world.vista, world.depth, world.depth_green, world.voxel, world.forest]:
		if n:
