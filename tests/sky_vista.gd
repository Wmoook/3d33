...
const SPOTS := {
	...
	"pool": Vector2i(150, 165), "logo": Vector2i(320, 45), "keep": Vector2i(300, 70), "grove_top": Vector2i(40, 30), "bottom": Vector2i(160, 197), "bottom_r": Vector2i(330, 197), "shrine": Vector2i(385, 78), "scroll": Vector2i(372, 40),
}
func _ready() -> void:
